        ...
        <>
            <div className='bg-zinc-900 text-white '>
                <div className="flex w-[35rem] mx-auto py-10 items-center justify-between">
                    <div className='h-[35rem] bg-zinc-800 w-full rounded-xl border-2 border-zinc-600'>
                ...
                <div className='h-[100vh]'>
                    <div className='w-[60%] mx-auto h-full flex flex-row p-4 gap-4 border-t border-zinc-600'>
                        <div className='w-[22rem] h-[20rem] flex flex-col gap-y-8 pt-[3rem] bg-zinc-800 rounded-xl items-center border-2 border-zinc-600'>
                        ...
                        <div className='w-full bg-zinc-800 h-[45rem] overflow-y-auto no-scrollbar rounded-xl border-2 border-zinc-600'>
                                <UserActivity/>
                        </div>
                    </div>
                </div>
